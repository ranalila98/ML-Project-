...
class DataIngestionConfig:
    train_data_path: str=os.path.join('artifaccts',"train.csv")
    test_data_path: str=os.path.join('artifaccts',"test.csv")
    raw_data_path: str=os.path.join('artifaccts',"data.csv")
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info("Train Tes split initiated")
